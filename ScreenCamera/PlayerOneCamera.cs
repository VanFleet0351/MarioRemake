...
namespace SprintZero.ScreenCamera
{
     ...
     */
    public class PlayerOneCamera
    {
        private static PlayerOneCamera instance;
        ...
        public static PlayerOneCamera Instance
        {
            get
            {
                if(instance == null)
                {
                    instance = new PlayerOneCamera
                    {
                        RightBound = 600,
                        LeftBound = 0,
                        VerticalView = 0,
        ...
        public void RewindView(Vector2 marioPos)
        {
            if (marioPos.X <= LeftBound + 100)
            {
                ViewPoint += -1*((int)marioPos.X - (LeftBound + 100));
